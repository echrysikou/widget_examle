...
const Df = ':host{--font-primary: "Roboto", sans-serif;--color-primary: #f44336}.subscription{text-align:center;padding:10px;max-width:400px;border-radius:6px;background-color:#fff;box-shadow:0 10px 15px -3px #0000001a;font-family:Roboto,sans-serif}.subscription__title{font-size:30px;font-weight:700;margin-bottom:10px;font-family:var(--external-font-primary, var(--font-primary));color:var(--external-color-primary, var(--color-primary))}.subscription__greeting{font-size:20px;margin:0 0 20px}.subscription__input{box-sizing:border-box;width:100%;padding:10px;border:1px solid #ccc;border-radius:6px;margin-bottom:10px}.subscription__mentions{font-size:14px;color:#666}', Ff = ({
  username: R,
